...
const CartItem = ({id, title, author, price, img, amount}) => {
    const {deleteOne, selectAmount} = useGlobalContext()
  return (
    <CartItems>
      <div className="image">
      ...
      <div>
        <BtnAmount className="amount-btn" onClick={() => selectAmount(id, "mas")}>
        ...
        <BtnAmount className="amount-btn" onClick={() => selectAmount(id, "menos")}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
